...
## Managed Data Services
  ...
  * [Rivestack](https://rivestack.io) - Managed PostgreSQL with pgvector optimized for AI workloads. The free tier includes 2GB storage and a built-in SQL editor that converts search queries to vector embeddings automatically.
